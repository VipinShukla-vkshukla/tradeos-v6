...
def main():
    ...
    if phase >= 2:
        all_steps = [
            ...
            # ── Output ──
            ("21_signal_snapshot",   step_signal_snapshot,     False), # immutable output freeze
            ("22_alerts",              step_alerts,              False),  # Telegram digest
            ("23_quality_check",       step_quality_check,       False), # data quality monitor with alerts
        ]
    else:
