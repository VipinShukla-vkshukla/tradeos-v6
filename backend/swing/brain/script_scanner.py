...
class ScriptScanner:
    ...
    def detect_table_usage(self, script_path: "Path") -> "tuple[list[str], list[str]]":
        ...
        try:
            from swing.brain.dynamic_registry import discover_all_tables
...
def run_scan(backend_root: str = None) -> tuple[list[dict], str, list[dict]]:
    ...
    new_proposals = []
    try:
        from swing.brain.script_profiler import profile_changed_scripts
    ...
    try:
        from swing.brain.consistency_checker import check_consistency
