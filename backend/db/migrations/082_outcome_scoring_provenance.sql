...
--
-- NUMBERED 082, NOT 080. The F-27 ledger entry below refers to this as
-- "migration 080" -- that was true on the branch it was written on, before
-- merge. 080 landed on main first as 080_gabriel_gap_entry_and_exit.sql
-- (18-Aug). Same reasoning as migration 079's own header: independent content,
-- renumbered rather than the ledger text edited, because a prior ledger entry
-- is never edited.
--
