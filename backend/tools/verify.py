...
MODULES = [
    ...
    ("IGN event study features — look-ahead guards, live-IGN parity, hand-computed values",
     "tests.test_ign_event_features"),
    ("IGN event study collector — request windows, per-day split, resumability",
    ...
    ("IGN event study selection — planted edge found, pure noise not, walk-forward leaks nothing",
    ...
    ("Kite history CLI — status, verify exit codes, token refusal, README limits",
     "tests.test_kite_history_cli"),
    ("Kite history report — coverage numbers, integrity pass, printed headline",
     "tests.test_kite_history_report"),
